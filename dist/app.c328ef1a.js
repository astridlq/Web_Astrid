...
},{"./debounce":"node_modules/lodash/debounce.js","./isObject":"node_modules/lodash/isObject.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var sr = ScrollReveal(); // HOMEPAGE:
// Header fade-in

sr.reveal('.header-quote', {
  origin: "right",
  delay: 200,
  duration: 2000,
  distance: '20px'
...
sr.reveal('.image-about-photo', {
  duration: 2000
});
sr.reveal('.image-about-paris', {
  duration: 2000
});
sr.reveal('.image-about-amsterdam', {
  duration: 2000
});
sr.reveal('.image-about-globe', {
  duration: 2000
});
sr.reveal('.image-title', {
  delay: 500,
  duration: 2000
});
sr.reveal('.image-title-1', {
  delay: 200,
  duration: 2000
}); // Titles appear
...
sr.reveal('.web-card-show-1', {
  delay: 300,
  duration: 2000,
  distance: '50px'
});
sr.reveal('.web-card-show-2', {
  delay: 400,
  duration: 2000,
  distance: '50px'
}); // CONTACT PAGE

sr.reveal('.profile-avatar', {
  delay: 200,
  duration: 2500
});
...
},{"lodash/throttle":"node_modules/lodash/throttle.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "58196" + '/');
